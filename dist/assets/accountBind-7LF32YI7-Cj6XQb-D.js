import{t as J,r as O,g as L}from"./unicode-JQcmJgeo.js";import{K as Q}from"./chunk-E64I5LL3-CUlxdamw.js";import{x as D}from"./chunk-U3EMLJZP-DQkL3ChG.js";import{p as I}from"./chunk-MYQNSXNS-DH2S_xSd.js";import{N as M}from"./chunk-KGYACALK-DwB-tQk9.js";import{Y as V,r as o,$ as H,m as K,o as t,B as U,ad as G,H as X,q as Z,s as P,M as ee,l as te,D as q,ae as ne}from"./index-CwMm_7HW.js";import{u as oe}from"./index-CgnqyHVB.js";import{u as j}from"./useRequest-DWSDEbZG.js";import{L as ae}from"./throttle-BoqW9Efe.js";import{u as W}from"./useTranslation-L85-XbTB.js";import{R as re}from"./DownOutlined-BnIpqCfS.js";import"./index-BGrVr97U.js";var Y=`.set-email-container {
  position: relative;
  display: flex;
...
`,ie=S=>{let{bindAccount:c,backToInputAccount:r,redirectUrl:a="",verifyToken:w=""}=S,T=D(),{t:l}=W(),{themeType:E,language:f}=H(),p=V(),[s,k]=o.useState(""),[_,d]=o.useState(1e3),[i,g]=o.useState(60),[m,b]=o.useState(),$=o.useRef(null),{authCoreModal:A}=K();oe(()=>{if(i>0){let e=i-1;g(e),e===0&&d(void 0)}},_);let{loading:u,run:N}=j(ne,{manual:!0,onSuccess:e=>{ee(),a?p(a.split("?")[0],{replace:!0,back:!0,state:{...te.parse(a.split("?")[1]),verifyToken:e==null?void 0:e.token,account:c}}):e.has_set_payment_password?p("/account/security",{replace:!0}):p("/account/set-password")},onError:e=>{(e==null?void 0:e.error_code)===q.InvalidCode?b(l("login.invalid_code")):(e==null?void 0:e.error_code)===q.ResendCode&&b(l("login.please_send_again"))}}),{loading:x,run:h}=j(G,{manual:!0,onSuccess:(e,n)=>{_||(g(60),d(1e3))},onError:e=>{g(0),d(void 0)}}),v=e=>{let n;c.includes("@")?n={email:c,code:e||s}:n={phone:c,code:e||s},w&&(n.token=w),N(n)},R=()=>{b(""),c.includes("@")?h({email:c}):P({theme:E,language:f,getContainer:()=>A.rootBody}).then(e=>{h({phone:c,cf_turnstile_response:e})}).catch(e=>{T.error(l("error.server_20112"))})},C=e=>{k(e),b(""),e.length===6&&y(e)},y=o.useCallback(ae(e=>{v(e)},1e3,{leading:!0,trailing:!1}),[]);o.useEffect(()=>{var e;let n=document.getElementsByClassName("react-input-code"),F=z=>z.preventDefault();return(e=n[0])==null||e.addEventListener("contextmenu",F),()=>{var z;(z=n[0])==null||z.removeEventListener("contextmenu",F)}},[]);let B=()=>{var e;(e=document.getElementsByClassName("input-code-item")[Math.min(s.length,5)])==null||e.focus()};return t.createElement("div",{className:"set-email-container"},t.createElement("style",null,Y),t.createElement(I,{className:"icon-navigation-back",name:"circle_back",onClick:r}),t.createElement("h2",{className:"set-email-title"},l("account.enter_code")),t.createElement("p",{className:"set-email-desc-2",style:{margin:20}},c),t.createElement("div",{onClick:B},t.createElement(Q,{containerClassName:"react-input-code",inputClassName:"input-code-item",allowedCharacters:"numeric",length:6,ref:$,placeholder:" ",onChange:C})),m&&t.createElement("div",{className:"code-error"},m),t.createElement(U,{disabled:s.length!==6,className:"account-submit-btn",loading:u,onClick:()=>v()},l("common.confirm")),t.createElement(U,{className:"send-again",onClick:R,disabled:i>0||x},i>0?`${l("login.send_again")} (${i}s)`:l("login.send_again")),t.createElement("div",{className:"back",onClick:r},t.createElement(I,{className:"arrow1-icon",name:"arrow1_icon"}),t.createElement("span",null,l("login.back"))),t.createElement(M,null))},ce=ie,le=S=>{let c=V(),{t:r}=W(),a=S,w=a==null?void 0:a.redirectUrl,T=a==null?void 0:a.verifyToken,l=D(),E=o.useRef(),[f,p]=o.useState(""),[s,k]=o.useState(["United States","us","1"]),[_,d]=o.useState(!1),i=o.useRef(null),[g,m]=o.useState(""),{themeType:b,language:$}=H(),{authCoreModal:A}=K(),[u,N]=o.useState("email");o.useEffect(()=>{if(u==="phone"||a!=null&&a.showSwitch){let e=J();e&&k(e)}},[u,a==null?void 0:a.showSwitch]);let[x,h]=o.useState(!1);o.useEffect(()=>{if(x)return document.addEventListener("click",v,!0),()=>{document.removeEventListener("click",v,!0)}},[x]);let v=e=>{setTimeout(()=>{var n;(n=E.current)!=null&&n.contains(e.target)||h(!1)})};o.useEffect(()=>{let e=a==null?void 0:a.accountType;e&&N(e)},[a]);let{loading:R,run:C}=j(G,{manual:!0,onSuccess:(e,n)=>{d(e)},onError:e=>{let n=(e==null?void 0:e.error_code)||0;(n===50003||n===50004)&&(p(""),i.current.value="")}}),y=()=>{let e=i.current.value;if(u==="email")if(e){if(!X.test(e))return m(r("login.email_format_error"))}else return m(r("account.input_vaild_email"));else{let n=s[1].toUpperCase();if(!e&&e!=="0")return m(r("account.input_vaild_mobile"));if(Z(e,n))e=`+${s[2]}${e}`;else return m(r("login.phone_format_error"))}p(e),e.includes("@")?C({email:e}):P({theme:b,language:$,getContainer:()=>A.rootBody}).then(n=>{C({phone:e,cf_turnstile_response:n})}).catch(n=>{l.error(r("error.server_20112"))})},B=()=>{N(u==="email"?"phone":"email"),p("")};return o.useEffect(()=>{setTimeout(()=>{var e;(e=i.current)==null||e.focus()})},[]),_?t.createElement(ce,{bindAccount:f,redirectUrl:w||"",verifyToken:T,backToInputAccount:()=>{d(!1)}}):t.createElement("div",{className:"set-email-container"},t.createElement("style",null,Y),t.createElement(I,{className:"icon-navigation-back",name:"circle_back",onClick:()=>c(-1)}),t.createElement("h2",{className:"set-email-title"},r(u==="email"?"account.set_your_email":"account.set_your_mobile")),t.createElement("p",{className:"set-email-desc-1"},r(u==="email"?"account.set_your_email_tip":"account.set_your_mobile_tip")),u==="email"?t.createElement(t.Fragment,null,t.createElement("div",{className:"account-input-box"},t.createElement("input",{onInput:()=>m(""),className:"input_email",type:"email",placeholder:r("account.place_email_address"),ref:i,defaultValue:f,onKeyDown:e=>{e.key==="Enter"&&y()}}))):t.createElement(t.Fragment,null,t.createElement("div",{className:"account-input-box phone",ref:E},x&&t.createElement("div",{className:"account-select-country"},O.map((e,n)=>t.createElement("p",{key:n,className:"account-select-country-item",onClick:()=>{k(e),h(!1)}},t.createElement("div",{className:"country-box"},t.createElement("div",{className:"country-flag"},L(`${e[1]}`)),t.createElement("span",{className:"country-name"},e[0])),t.createElement("div",{className:"country-code"},"+"+e[2])))),t.createElement("div",{className:"account-select-opt",onClick:()=>h(!x)},t.createElement("div",{className:"account-select-icon"},L(`${s[1]}`)),t.createElement(re,{className:"down-more"})),t.createElement("span",null,"+",s[2]),t.createElement("input",{onInput:()=>{var e;m(""),i.current.value=((e=i.current.value.match(/^\d+/))==null?void 0:e[0])||""},type:"text",className:"no-number dd",placeholder:r("account.mobile"),ref:i,onWheel:e=>e.target.blur(),defaultValue:f.replace(`+${s[2]}`,""),onKeyDown:e=>{e.key==="Enter"&&y()},onFocus:()=>{var e;(e=document.querySelector(".account-input-box.phone"))==null||e.setAttribute("data-focus","true")},onBlur:()=>{var e;(e=document.querySelector(".account-input-box.phone"))==null||e.setAttribute("data-focus","false")}}))),t.createElement("p",{className:`error-tip ${g?"show":""}`},g),t.createElement(U,{className:"send-code-btn account-submit-btn bottom-margin",loading:R,onClick:y},r("login.get_captcha")),(a==null?void 0:a.showSwitch)&&t.createElement("div",{className:"account-switch-item",onClick:B},r(u==="email"?"account.switch_text_mobile":"account.switch_text_email")),t.createElement(M,null))},we=le;export{we as default};
