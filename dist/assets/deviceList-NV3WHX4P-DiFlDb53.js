...
`,xe=()=>{let{t:n}=Z(),e=V(),{modalOptions:i}=X(),{language:v}=F(),{loading:d,data:r=[],run:s}=Q(()=>G().then(l=>l.map(t=>{var c,m;if(t.updated_at&&(t.updated_at=T(new Date(t.updated_at)).format("YYYY/MM/DD HH:mm")),i.projectId===t.project_app_uuid&&(t.isCurrent=!0),t.login_channel&&(t.login_channel=t.login_channel.replace(/( |^)[a-z]/g,o=>o.toUpperCase())),(c=t==null?void 0:t.location)!=null&&c.country_code)try{t.location.country_name=new Intl.DisplayNames([v||"en"],{type:"region"}).of((m=t==null?void 0:t.location)==null?void 0:m.country_code)}catch{}return t})),{cacheKey:"getAuthorizations",manual:!0});return a.useEffect(()=>{s()},[]),u.createElement("div",{className:"device-list-container"},u.createElement("style",null,fe),u.createElement(H,{displayBackBtn:!0},n("new.authorization")),u.createElement("div",{className:"scroll-wrapper"},u.createElement("div",{className:"devices-description"},n("new.authorization_tips")),d?u.createElement("div",{className:"device-list"},u.createElement(w,null)):u.createElement("div",{className:"device-list"},r==null?void 0:r.map((l,t)=>u.createElement("div",{className:"item",key:t,onClick:()=>{e("/manageDevices/deviceDetails",{state:{loginDeviceInfo:l}})}},u.createElement("div",{className:"left"},u.createElement("div",{className:"wrap"},u.createElement("div",{className:"s-row device"},l.project_app_name),u.createElement("div",{className:"s-row created_at"},l.updated_at))),u.createElement("div",{className:"right"},l.isCurrent&&u.createElement("div",{className:"current-icon"},n("new.current")),u.createElement(K,{className:"arrow-right-icon",name:"arrow_right_icon"})))))),u.createElement(W,{className:"footer-box-v2"}))},_e=xe;export{_e as default};
