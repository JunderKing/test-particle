...
`,O=({authType:i,isFailed:t=!0})=>{let{t:a}=U(),[o,c]=e.useState(!t),{socialAuthLogin:r}=W();return e.createElement("div",{className:"social-loading-content"},e.createElement("style",null,J),e.createElement("div",{className:"wrap"},e.createElement("div",{className:`social-logo-content ${t?"failed":""}`,onClick:()=>{!t||o||(c(!0),r({socialType:i}))}},e.createElement("div",{className:"logo"},e.createElement("img",{src:k()[i]||"",alt:"logo"})),o&&e.createElement("div",{className:"spin"},e.createElement("img",{src:Z,alt:"loading"})),t&&!o&&e.createElement("div",{className:"refresh-btn"},e.createElement(b,{className:"refresh-icon",name:"refresh_icon"}))),e.createElement("div",{className:"title"},a(t?"login.request_failed":"login.logging_you_in")),t&&e.createElement("div",{className:"desc"},a("login.something_wrong"))),e.createElement(H,{className:"footer-box-v2"}))},R=O,V=`.index-container {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 100%;
